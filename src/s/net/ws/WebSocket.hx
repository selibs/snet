...
extern class WebSocket {
	public static inline function computeKey(key:String):String
		return Base64.encode(Sha1.make(Bytes.ofString(key + '258EAFA5-E914-47DA-95CA-C5AB0DC85B11')));

	public static inline function writeFrame(data:Bytes, opcode:OpCode, isMasked:Bool, isFinal:Bool):Bytes {
	...
	public static inline function readFrame(bytes:Bytes):{opcode:OpCode, isFinal:Bool, data:Bytes} {
		var pos = 0;
		...
		return {opcode: opcode, isFinal: isFinal, data: payload};
	}
}
#end
